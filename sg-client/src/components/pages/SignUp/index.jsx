  ...
  return (
    <div class="sigup_wrap_div">
      <div class="sigup_wrap">
        ...
        <form class="form-signin" id='signup_form' name='signup_form' method="POST" action='login_signup_db.php' style={{ marginTop: "15px" }} onsubmit=" return formsubmit(this);">
          <div class="form-group">
            <label for="email" class="blind"> 아이디, 이메일 주소 </label>
            <input class="form-control" type="text" name="email" id="email" placeholder="ID(이메일 주소)" required />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="password" name="password_check" id="password_check" placeholder="비밀번호 확인" required />
          </div>
          <div class="form-group">
            <label for="manager" class="blind"> 담당자 이름 </label>
            <input class="form-control" type="text" name="manager" id="manager" placeholder="이름(담당자)" required />
          </div>
          <div class="form-group">
            <label for="manager_phone" class="blind"> 담당자 휴대폰 번호 </label>
            <input class="form-control" type="text" name="manager_phone" id="manager_phone" placeholder="휴대폰번호(담당자)" required />
          </div>
          <div class="form-group">
            <label for="company" class="blind"> 고객명 </label>
            <input class="form-control" type="text" name="company" id="company" placeholder="고객명" required />
          </div>
          <div class="form-group">
            <label for="company_tel" class="blind"> 고객전화번호 </label>
            <input class="form-control" type="text" name="company_tel" id="company_tel" placeholder="고객전화번호(대표번호)" required />
          </div>
          <div class="form-group">
            <div>
          ...
          <div class="form-group">
            <button class="btn_big" type="submit">가입하기</button>
          </div>
        </form>
      </div>
    </div>
