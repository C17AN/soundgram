<?php
	...
	$query 
	= " 	select a.diskpath, a.diskid, b.chip_img, b.chip_loading
			from
				(select diskpath, diskid, album_id from APIServer_apppage where album_id = '$albumid') a,
				(select id, chip_img, chip_loading from APIServer_album) b
			where a.album_id = b.id	";
