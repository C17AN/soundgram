<?php
	...
	if($result>0) {
		...
		$updateQuery1 
		= " update APIServer_device set user_id=NULL, login_status='0', login_last_time=NULL where user_id='$user_id' $plus_sql";
		...
		$updateQuery2 
		= " update APIServer_device set user_id='$user_id', login_status='1', login_last_time=NOW() where id='$device_id' $plus_sql";
